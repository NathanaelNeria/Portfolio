...
export const testimonials = [
  {
    quote: "Nathanael delivers clean, modern interfaces with great attention to detail. A reliable frontend partner.",
    name: "Rekan Klien",
    role: "Product Owner",
  },
  {
    quote: "His ability to translate complex designs into smooth, responsive code is impressive.",
    name: "Tim Developer",
    role: "Tech Lead",
  },
];
...
export const socialLinks = [
  { name: "GitHub", href: "https://github.com/nathanaelneria" },
  { name: "LinkedIn", href: "https://www.linkedin.com/in/nathanael-neria-2539b4117" },
  { name: "Email", href: "mailto:nathanaelneria@gmail.com" },
];
